...
public class RegistroHuesped extends JFrame {
	...
	private void guardarHuesped() {	
		...
		Huespedes nuevoHuesped = new Huespedes(txtNombre.getText(), txtApellido.getText(),  java.sql.Date.valueOf(fechaNacimiento), txtNacionalidad.getSelectedItem().toString(),txtTelefono.getText(), numReserva);
