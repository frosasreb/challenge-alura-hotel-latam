...
public class ReservasView extends JFrame {
	...
	protected void calcularPrecio(JDateChooser fechaEntrada, JDateChooser fechaSalida) {
	...
	private void guardarReserva() {	
		...
		Reservaciones nuevaReserva = new Reservaciones(java.sql.Date.valueOf(fechaEntrada), java.sql.Date.valueOf(fechaSalida),txtValor.getText(),txtFormaPago.getSelectedItem().toString());
		reservacionesController.guardar(nuevaReserva);
